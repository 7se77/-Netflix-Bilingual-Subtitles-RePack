...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _util=require("./util");class Kuroshiro{constructor(){this._analyzer=null}async init(a){if(!a||"object"!=typeof a||"function"!=typeof a.init||"function"!=typeof a.parse)throw new Error("Invalid initialization parameter.");if(null!=this._analyzer)throw new Error("Kuroshiro has already been initialized.");await a.init(),this._analyzer=a}async convert(a,r){if((r=r||{}).to=r.to||"hiragana",r.mode=r.mode||"normal",r.romajiSystem=r.romajiSystem||_util.ROMANIZATION_SYSTEM.HEPBURN,r.delimiter_start=r.delimiter_start||"(",r.delimiter_end=r.delimiter_end||")",a=a||"",-1===["hiragana","katakana","romaji"].indexOf(r.to))throw new Error("Invalid Target Syllabary.");if(-1===["normal","spaced","okurigana","furigana"].indexOf(r.mode))throw new Error("Invalid Conversion Mode.");if(-1===Object.keys(_util.ROMANIZATION_SYSTEM).map(a=>_util.ROMANIZATION_SYSTEM[a]).indexOf(r.romajiSystem))throw new Error("Invalid Romanization System.");const e=await this._analyzer.parse(a),i=(0,_util.patchTokens)(e);if("normal"===r.mode||"spaced"===r.mode)switch(r.to){case"katakana":return"normal"===r.mode?i.map(a=>a.reading).join(""):i.map(a=>a.reading).join(" ");case"romaji":const a=a=>{let e;return e=(0,_util.hasJapanese)(a.surface_form)?a.pronunciation||a.reading:a.surface_form,(0,_util.toRawRomaji)(e,r.romajiSystem)};return"normal"===r.mode?i.map(a).join(""):i.map(a).join(" ");case"hiragana":for(let a=0;a<i.length;a++)if((0,_util.hasKanji)(i[a].surface_form))if((0,_util.hasKatakana)(i[a].surface_form)){i[a].reading=(0,_util.toRawHiragana)(i[a].reading);let r="",e="";for(let r=0;r<i[a].surface_form.length;r++)(0,_util.isKanji)(i[a].surface_form[r])?e+="(.*)":e+=(0,_util.isKatakana)(i[a].surface_form[r])?(0,_util.toRawHiragana)(i[a].surface_form[r]):i[a].surface_form[r];const t=new RegExp(e).exec(i[a].reading);if(t){let e=0;for(let n=0;n<i[a].surface_form.length;n++)(0,_util.isKanji)(i[a].surface_form[n])?(r+=t[e+1],e++):r+=i[a].surface_form[n];i[a].reading=r}}else i[a].reading=(0,_util.toRawHiragana)(i[a].reading);else i[a].reading=i[a].surface_form;return"normal"===r.mode?i.map(a=>a.reading).join(""):i.map(a=>a.reading).join(" ");default:throw new Error("Unknown option.to param")}else if("okurigana"===r.mode||"furigana"===r.mode){const a=[];for(let r=0;r<i.length;r++){switch((0,_util.getStrType)(i[r].surface_form)){case 0:a.push([i[r].surface_form,1,(0,_util.toRawHiragana)(i[r].reading),i[r].pronunciation||i[r].reading]);break;case 1:let e="",t=!1;const n=[];for(let a=0;a<i[r].surface_form.length;a++)(0,_util.isKanji)(i[r].surface_form[a])?t?n[n.length-1]+=i[r].surface_form[a]:(t=!0,e+="(.+)",n.push(i[r].surface_form[a])):(t=!1,n.push(i[r].surface_form[a]),e+=(0,_util.isKatakana)(i[r].surface_form[a])?(0,_util.toRawHiragana)(i[r].surface_form[a]):i[r].surface_form[a]);const o=new RegExp(`^${e}$`).exec((0,_util.toRawHiragana)(i[r].reading));if(o){let r=1;for(let e=0;e<n.length;e++)(0,_util.isKanji)(n[e][0])?(a.push([n[e],1,o[r],(0,_util.toRawKatakana)(o[r])]),r+=1):a.push([n[e],2,(0,_util.toRawHiragana)(n[e]),(0,_util.toRawKatakana)(n[e])])}else a.push([i[r].surface_form,1,(0,_util.toRawHiragana)(i[r].reading),i[r].pronunciation||i[r].reading]);break;case 2:for(let e=0;e<i[r].surface_form.length;e++)a.push([i[r].surface_form[e],2,(0,_util.toRawHiragana)(i[r].reading[e]),i[r].pronunciation&&i[r].pronunciation[e]||i[r].reading[e]]);break;case 3:for(let e=0;e<i[r].surface_form.length;e++)a.push([i[r].surface_form[e],3,i[r].surface_form[e],i[r].surface_form[e]]);break;default:throw new Error("Unknown strType")}}let e="";switch(r.to){case"katakana":if("okurigana"===r.mode)for(let i=0;i<a.length;i++)1!==a[i][1]?e+=a[i][0]:e+=a[i][0]+r.delimiter_start+(0,_util.toRawKatakana)(a[i][2])+r.delimiter_end;else for(let i=0;i<a.length;i++)1!==a[i][1]?e+=a[i][0]:e+=`<ruby>${a[i][0]}<rp>${r.delimiter_start}</rp><rt>${(0,_util.toRawKatakana)(a[i][2])}</rt><rp>${r.delimiter_end}</rp></ruby>`;return e;case"romaji":if("okurigana"===r.mode)for(let i=0;i<a.length;i++)1!==a[i][1]?e+=a[i][0]:e+=a[i][0]+r.delimiter_start+(0,_util.toRawRomaji)(a[i][3],r.romajiSystem)+r.delimiter_end;else{e+="<ruby>";for(let i=0;i<a.length;i++)e+=`${a[i][0]}<rp>${r.delimiter_start}</rp><rt>${(0,_util.toRawRomaji)(a[i][3],r.romajiSystem)}</rt><rp>${r.delimiter_end}</rp>`;e+="</ruby>"}return e;case"hiragana":if("okurigana"===r.mode)for(let i=0;i<a.length;i++)1!==a[i][1]?e+=a[i][0]:e+=a[i][0]+r.delimiter_start+a[i][2]+r.delimiter_end;else for(let i=0;i<a.length;i++)1!==a[i][1]?e+=a[i][0]:e+=`<ruby>${a[i][0]}<rp>${r.delimiter_start}</rp><rt>${a[i][2]}</rt><rp>${r.delimiter_end}</rp></ruby>`;return e;default:throw new Error("Invalid Target Syllabary.")}}}}const Util={isHiragana:_util.isHiragana,isKatakana:_util.isKatakana,isKana:_util.isKana,isKanji:_util.isKanji,isJapanese:_util.isJapanese,hasHiragana:_util.hasHiragana,hasKatakana:_util.hasKatakana,hasKana:_util.hasKana,hasKanji:_util.hasKanji,hasJapanese:_util.hasJapanese,kanaToHiragna:_util.kanaToHiragna,kanaToKatakana:_util.kanaToKatakana,kanaToRomaji:_util.kanaToRomaji};Kuroshiro.Util=Util;var _default=exports.default=Kuroshiro;
